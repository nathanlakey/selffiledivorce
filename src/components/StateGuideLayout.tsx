        ...
        <article className="prose-content min-w-0">
          ...
          <div className="flex items-center gap-3 mt-10 pt-6 border-t border-border">
            <div className="w-10 h-10 rounded-full bg-navy flex items-center justify-center flex-shrink-0">
              <span className="font-display text-base font-bold text-gold">SL</span>
            </div>
            <div>
              ...
              <p className="font-body text-xs text-text-light leading-relaxed">
                Researched using official state court websites and verified legal aid
                resources. Filing fees and procedures verified June 2026.
